...
void answer(long long x1, long long y1, long long z1, long long x2, long long y2, long long z2, long long x3, long long y3, long long z3, long long x4, long long y4, long long z4){
    ...
    if (tn == 0)
        ...
        tc = tn / td;
    long long fenzi = pow(wx*sd*td + sn*ux*td - tn*vx*sd, 2) + pow(wy*sd*td + sn*uy*td - tn*vy*sd, 2) + pow(wz*sd*td + sn*uz*td - tn*vz*sd, 2);
    long long fenmu = pow(sd*td, 2);
...
int main(){
    ...
    for(int k = 1; k <= T; k++){
        ...
        scanf("%I64d %I64d %I64d %I64d %I64d %I64d", &x3, &y3, &z3, &x4, &y4, &z4);
