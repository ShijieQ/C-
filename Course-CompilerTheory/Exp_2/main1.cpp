...
using namespace std;
string *grammar;  //文法G
string *grammarSet;  //产生式集合P
string Vn, Vt;                 //文法G非终结符集合U，终结符集合u
int numOfVn, numOfVt, numOfG;                 //非终结符、终结符个数,产生式数
string *grammarAfter; //消除左递归后的文法GG
string *grammarSetAfter; //文法GG的产生式集合PP
string VnAfter, VtAfter;               //文法GG非终结符集合U，终结符集合u
